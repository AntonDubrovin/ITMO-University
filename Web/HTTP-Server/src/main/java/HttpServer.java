...
class HttpServer {
    ...
    private String parseUri(String uri) throws IOException {
    ...
    private void process(Request request, Response response) throws IOException {
        ...
        File file = new File(root, parseUri(request.getUri()));
        ...
        if (file.isFile()) {
            ...
            String ifNoneMach = request.getHeader("If-None-Match");
            response.setHeader("ETag", eTag);
            if (ifNoneMach != null && ifNoneMach.equals(eTag)) {
